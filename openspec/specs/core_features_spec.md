...
*   `POST /api/v1/diary` (Tạo nhật ký mới)
    *   *Payload DTO (`CreateDiaryEntryDto`):*
        ...
        ```
    *   *Response (210 Created):* Trả thực thể nhật ký vừa tạo và kích hoạt sự kiện tăng streak chăm chỉ cho thú ảo [PetModule](file:///d:/coding/farmdiary/project/backend/src/modules/pet).
