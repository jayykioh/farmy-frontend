...
export const createDiaryRequestHash = async (input: DiaryHashInput): Promise<string> => {
  return sha256Hex(buildCanonicalDiaryJson(input));
};

export const createBlobDigest = async (blob: Blob): Promise<string> => {
