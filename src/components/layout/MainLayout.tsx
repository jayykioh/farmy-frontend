  ...
  return (
    <div className="flex min-h-[100svh] w-full bg-bg-main font-sans relative">
      ...
      <div className={`flex flex-col flex-1 w-full relative transition-all duration-300 ${showBottomNav ? 'md:ml-[260px]' : ''}`}>
        ...
        {showBottomNav && !isPageHeaderVisible ? (<header className="sticky top-0 w-full z-40 bg-bg-main/80 backdrop-blur-md flex justify-between items-center px-4 md:px-6 py-2.5 h-14 shadow-sm border-b border-border-main/40 transition-all duration-300">
